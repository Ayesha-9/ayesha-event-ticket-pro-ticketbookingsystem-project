...
<body>
    <header>
        <h5 style="color: silver;font-family: 'Rubik One'; font-size:21px;"><b><i class="fa-brands fa-github"></i> | HANSON BROTHERS</h5>
    </header>
<body>

<div id="step1">
    <h1>Show Name: Mystical Marvels.Spellbinding Sorcery</h1>
    <p>Date: 2023-12-18</P> 
    <p>Time: 05:30</p> 
    <p>Location: Mico layout,Banerghatta road ,Bangalore 560076</p>
...
<script>
    $(document).ready(function() {
        var ticketPrice = 500; // Change this value as per the actual ticket price
        var totalTickets = 0;
    ...
    <footer>
        <p style="color: silver;font-family: 'Rubik One';font-size:18px;"><b>CONTACT US<b></p>
        <p>India: +91 8135509322</P>
